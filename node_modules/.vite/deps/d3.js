...
function partition_default() {
  ...
  function partition(root4) {
    ...
    if (round)
      root4.eachBefore(round_default);
    return root4;
  }
...
var rgb_default = function rgbGamma(y4) {
  ...
  function rgb3(start, end) {
    var r = color2((start = rgb2(start)).r, (end = rgb2(end)).r), g = color2(start.g, end.g), b = color2(start.b, end.b), opacity = nogamma(start.opacity, end.opacity);
    return function(t) {
      start.r = r(t);
      start.g = g(t);
      start.b = b(t);
...
function cubehelix3(hue2) {
  return function cubehelixGamma(y4) {
    y4 = +y4;
    function cubehelix4(start, end) {
      var h = hue2((start = cubehelix2(start)).h, (end = cubehelix2(end)).h), s2 = nogamma(start.s, end.s), l = nogamma(start.l, end.l), opacity = nogamma(start.opacity, end.opacity);
      return function(t) {
        start.h = h(t);
        start.s = s2(t);
...
function calendar(ticks3, tickInterval, year, month, week, day, hour, minute, second2, format2) {
  ...
  scale2.nice = function(interval) {
    ...
    return interval ? domain(nice3(d, interval)) : scale2;
  };
  scale2.copy = function() {
